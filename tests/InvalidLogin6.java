...
// This is to check if the login will pass with the correct format of the email and only letters in password 
// and check if there is a password error message

public class InvalidLogin6 {
	
	public static final String EMAIL = "milaan88@gmail.com";
	public static final String PASS = "Passss";
