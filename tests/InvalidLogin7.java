...
// This is to check if the login will pass with the correct format of the email and only numbers in the password
// and and check if there is a password error message

public class InvalidLogin7 {
